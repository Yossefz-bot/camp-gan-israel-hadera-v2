...
export async function onRequest({ request, env }) {
  ...
  for (const [key, raw] of Object.entries(input)) {
    ...
    if (['show_testimonials','show_songs','show_countdown','allow_testimonial_submission','allow_newsletter_signup','allow_contact_form'].includes(key)) value = value === '1' || value === 'true' ? '1' : '0';
